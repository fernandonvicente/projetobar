            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li class="user-pro">
                        <a href="#" class="waves-effect"><img src="<?php echo e(url('/assets_plugin_admin/plugins/images/users/varun.jpg')); ?>" alt="user-img" class="img-circle"> <span class="hide-menu"> Steve Gection<span class="fa arrow"></span></span>
                        </a>
            ...
            </div><?php /**PATH C:\xampp\htdocs\laravelseterenan\resources\views/admin/layout/navbar-default.blade.php ENDPATH**/ ?>