   ...
   var table = $('#tb_datatable').DataTable({
    ...
    oLanguage: {
      ...
      dom: 'Bfrtip',
       ...
       serverSide: true,
       ajax: {
           url: '<?php echo url("/area-cliente/comandas/carregaTabela"); ?>',
           data: function ( d ) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.template_cliente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bayarea\resources\views/area-cliente/comandas.blade.php ENDPATH**/ ?>