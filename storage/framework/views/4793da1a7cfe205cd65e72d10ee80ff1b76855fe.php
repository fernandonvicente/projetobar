                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo e(url('bayareaadmin/user/edit')); ?>/<?php echo e($user->id); ?>"><i class="fa fa-fw fa-edit" title="Editar"></i></a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_usuarios')): ?>
                                            <a href="javascript:void(0);" onclick="excluirRegistro(<?php echo e($user->id); ?>);"><i class="fa fa-trash" title="Excluir" style="color: #ff0000;"></i></a>
                                            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bayarea\resources\views/admin/user/indexajax.blade.php ENDPATH**/ ?>