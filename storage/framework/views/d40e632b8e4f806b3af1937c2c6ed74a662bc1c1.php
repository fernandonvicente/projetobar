...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Gerenciamento Antena'); ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(route('admin::home')); ?>" class="logo">
      ...
      <span class="logo-lg"><b>Antena</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(url('/bayareaadmin/user/edit')); ?>/<?php echo e(Auth::user()->id); ?>" class="btn btn-default btn-flat">Perfil</a>
                </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-<?php echo date('Y');?> <a href="<?php echo e(url('/bayareaadmin')); ?>">Gerenciamento Antena</a>.</strong> Todos os direitos reservados.
  </footer>
...
</html><?php /**PATH C:\xampp\htdocs\bayarea\resources\views/admin/layout/template.blade.php ENDPATH**/ ?>