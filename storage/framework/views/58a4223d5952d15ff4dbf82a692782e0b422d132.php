          ...
          <p>
            <div class="row">
                <div class="col-lg-2 col-sm-4 col-xs-12">
                  <a href="<?php echo e(url('/bayareaadmin/comanda/create')); ?>">
   ...
   var table = $('#tb_datatable').DataTable({
    ...
    oLanguage: {
      ...
      dom: 'Bfrtip',
       ...
       serverSide: true,
       ajax: {
           url: '<?php echo url("/bayareaadmin/comanda/carregaTabela"); ?>',
           data: function ( d ) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.template2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bayarea\resources\views/admin/comanda/indexajax.blade.php ENDPATH**/ ?>