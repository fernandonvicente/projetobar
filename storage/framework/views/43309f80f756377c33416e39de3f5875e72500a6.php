...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
             <?php echo $__env->make('admin.layout.navbar-header-cliente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- /.navbar-header -->
            <!-- /.navbar-top-links -->
            <!-- /.navbar-static-side -->
        </nav>
        ...
        <div class="navbar-default sidebar" role="navigation">
           <?php echo $__env->make('admin.layout.navbar-default-cliente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- ============================================================== -->
        <!-- End Left Sidebar -->
        <!-- ============================================================== -->
...
<?php /**PATH C:\xampp\htdocs\bayarea\resources\views/admin/layout/template_cliente.blade.php ENDPATH**/ ?>