    ...
    <section id="wrapper" class="new-login-register bg-theme-dark">
        <div class="lg-info-panel">
            <div class="inner-panel">
                <a href="javascript:void(0)" class="p-20 di"><img src="<?php echo e(url('/assets_plugin_admin/plugins/images/admin-logo.png')); ?>"></a>
        ...
        <div class="new-login-box">
            <div class="white-box">
                ...
                <form class="form-horizontal new-lg-form" id="loginform" method="POST" action="<?php echo e(url('/login')); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravelseterenan\resources\views/auth/login.blade.php ENDPATH**/ ?>