...
<body>
  ...
  <p style="background-color: #FFFF00;">
    <strong>2 – OBJETO DO CONTRATO:</strong> 2.1 – O presente Instrumento Particular tem por objeto a prestação de serviços jurídicos para a defesa dos direitos da <strong>CONTRATANTE</strong>, mediante a propositura de ação judicial, com pedido de tutela de urgência, cujo objeto é a INIBIÇÃO dos nomes dos ASSOCIADOS junto aos ORGÃOS DE PROTEÇÃO AO CRÉDITO em Território Nacional, com abrangência em todos os tipos de restrições. O Processo tem como finalidade a permanência do bloqueio de futuras “inserções” de negativações junto aos Órgãos SERASA, <span style="background-color: #00FF00; font-weight: bold;">mantendo “blindados” pelo prazo de 12 meses</span>, à partir da data de efetivação da prestação de serviço contratada. 
  </p>


  <p>
    2.2 – Relação beneficiários propositura do Processo Judicial: 
  </p>
...
<tr style="font-weight: bold; color: #2F5597;">
  ...
  <p>
    <strong>6 – DISPOSIÇÕES GERAIS: 6.1</strong> – Fica estabelecido entre as partes que a prestação de serviços objeto do presente, caracteriza-se por um serviço de resultados.
  </p>

  <p>
    <strong>6.2</strong> - O CONTRATANTE declara ter sido devidamente cientificado pelo CONTRATADO de todas as peculiaridades da situação em que se encontra, da morosidade processual, da extrema complexidade da natureza desse litígio.   
  </p>

  <p><strong>6.3</strong> - O CONTRATANTE desde já autoriza a divulgação das decisões administrativas e/ou judiciais inerentes deste Instrumento. </p>

  <p>
    <strong>7 – DISPOSIÇÕES FINAIS: 7.1</strong> – O presente contrato é um título executivo extrajudicial conforme previsão legal e em caso de inadimplemento da cliente, permite a propositura de ação de execução autônoma para o recebimento dos honorários devidos e não pagos.                                                                                                                           
  </p>

  <p>
    <strong>7.2</strong> – Todas as informações relacionadas neste documento, referentes às consultas realizadas e situação cadastral e crédito, são de caráter confidenciais e não podem ser repassadas e ou divulgadas, senão pelo CONTRATANTE. 
  </p>
