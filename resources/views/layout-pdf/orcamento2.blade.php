...
<body>
  <div id="header">
    <table border="0"  width="100%" style="border-bottom: 1px solid #000000; font-size: 8pt;">
      <tr>
          <td>
            <img alt="" title="" width="810" height="150" src="{{asset('assets/img/header.png')}}">
          </td>          
      </tr>
  </table>
  </div>
    ...
    <table width="100%" style="vertical-align: bottom; font-size: 8pt; color: #000000; border-top: 0px solid #000000;">
      ...
      <tr>
          <td width="100%" align="center">
              ...
              <img alt="" title="" width="810" height="100" src="{{asset('assets/img/footer.png')}}">
          </td>
      </tr>
  </table>
  </div>
...
nacional), sem que haja inclusão de novos apontamentos, (durante 18 meses Serasa). *Prazo à ser negociado.
...
“inserções” de negativações junto aos Órgãos SERASA, <span style="background-color: #00FFFF;">mantendo “blindados” pelo prazo médio de 18 meses</span>, à partir da data de efetivação da
