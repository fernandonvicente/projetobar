...
<ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?= ($pagActual == 'cliente') ? 'active menu-open' : null; ?>">
          ...
          <ul class="treeview-menu" style="<?= ($pagActual == 'cliente') ? 'display: block;' : 'display: none;'; ?>">
            ...
            <li class="<?= ($pagActualNivel == 'create' ) ? 'active' : null; ?>"><a href="{{ url('bayareaadmin/cliente/create') }}"><i class="fa fa-circle-o"></i> Cadastro</a></li>
                        
            <li class="<?= ($pagActualNivel == 'index' ) ? 'active' : null; ?>"><a href="{{ url('bayareaadmin/cliente/index') }}"><i class="fa fa-circle-o"></i> Lista</a></li>
        ...
        <li class="treeview <?= ($pagActual == 'plano') ? 'active menu-open' : null; ?>">
          ...
          <ul class="treeview-menu" style="<?= ($pagActual == 'plano') ? 'display: block;' : 'display: none;'; ?>">
            ...
            <li class="<?= ($pagActualNivel == 'create' ) ? 'active' : null; ?>"><a href="{{ url('bayareaadmin/plano/create') }}"><i class="fa fa-circle-o"></i> Cadastro</a></li>
                        
            <li class="<?= ($pagActualNivel == 'index' ) ? 'active' : null; ?>"><a href="{{ url('bayareaadmin/plano/index') }}"><i class="fa fa-circle-o"></i> Lista</a></li>
