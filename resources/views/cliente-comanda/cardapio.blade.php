                ...
                <div class="panel-body">
                    <div class="table-responsive scroll">
                        <table class="table product-overview">
                            ...
                            <tbody>
                                <tr>
                                    <td width="150"><img src="{{ url('/assets_plugin_admin/plugins/images/chair.jpg') }}" alt="iMac" width="80"></td>
                                    <td width="550">
                                ...
                                <tr>
                                    <td><img src="{{ url('/assets_plugin_admin/plugins/images/chair2.jpg') }}" alt="iMac" width="80"></td>
                                    <td>
                                        <h5 class="font-500">Rounded Chair</h5>
                                        <p>Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look</p>
                                    </td>
                                ...
                                <tr>
                                    <td><img src="{{ url('/assets_plugin_admin/plugins/images/chair3.jpg') }}" alt="iMac" width="80"></td>
                                    <td>
                                        <h5 class="font-500">Rounded Chair</h5>
                                        <p>Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look</p>
                                    </td>
                                ...
                                <tr>
                                    <td><img src="{{ url('/assets_plugin_admin/plugins/images/chair4.jpg') }}" alt="iMac" width="80"></td>
                                    <td>
                                        <h5 class="font-500">Rounded Chair</h5>
                                        <p>Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look</p>
                                    </td>
