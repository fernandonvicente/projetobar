        ...
        <div class="login-box login-sidebar bg-theme-dark">
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginClienteForm" name="loginClienteForm" action="javascript:void(0);" enctype="multipart/form-data" method="post">
                    {{ csrf_field() }}
                    <a href="javascript:void(0)" class="text-center db"><img src="{{ url('/assets_plugin_admin/plugins/images/admin-logo.png') }}" alt="Home" />
                        <br/><img src="{{ url('/assets_plugin_admin/plugins/images/admin-text.png') }}" alt="Home" /></a>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Não tem conta? <a href="{{ url('/cliente/cadastro') }}" class="text-primary m-l-5"><b>Inscrever-se</b></a></p>
                        </div>
                    </div>
                </form>
